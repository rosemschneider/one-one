...
### Participants
Our current sample includes `r demos.2$total.n[1]` children out of a planned sample of 40 ($M_{age}$ = `r round(mean_age.2, 2)` years, $SD_{age}$ = `r round(sd_age.2, 2)` years, range = `r round(min_age.2, 2)` - `r round(max_age.2, 2)` years). All children were classified as CP-knowers by the Give-N task.
...
## finally, group IDKs and numeric together and look at accuracy 
