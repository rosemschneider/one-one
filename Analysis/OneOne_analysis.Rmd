...
##Distribution of responses for parallel set 
Looking at variance around the requested item
```{r}
all.data %>%
  filter(Task == "Parallel")%>%
...
ggsave("/Users/roseschneider/Documents/Projects/one-one/Analysis/Figures/dist_response.png", width = 7, height = 3.5)
