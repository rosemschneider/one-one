...
# SETUP ----
source("Study 2.1/Analysis/0-clean.R") # data cleaning script, produces cleaned data 
# Load cleaned data - 2 dfs
rm(list = ls())
load("Study 2.1/Data/one-one_control_cleaned.RData") #study 2 all data
load("Study 2.1/Data/one-one_control_check_cleaned.RData") #study 2 check data
...
tmp %>% 
  ...
  labs(x = "Each line = individual participant", 
       y = "Response/Set size")
ggsave("Figures/numeric_distance.png", width = 5.5, height = 4)
