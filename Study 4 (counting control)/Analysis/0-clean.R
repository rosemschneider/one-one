#Data cleaning script for one-to-one set-matching control study (Study 4)
#rose schneider
...
# Read in data ----
data.raw <- read.csv('Study 4 (counting control)/Data/1-1_Control data - Data.csv')%>%
...
save(all.data.study2, file="Study 4 (counting control)/Data/one-one_control_cleaned.RData")
save(counting.check.df, file = "Study 4 (counting control)/Data/one-one_control_check_cleaned.RData")

write.csv(all.data.study2, file="Study 4 (counting control)/Data/one-one_control_cleaned.csv")
